...
def main():
    ...
    while i <= 5222:
        ...
        i += 1
    X = np.array(feature_all).reshape(len(feature_all), len(feature_all[0])*2) # 修正输入
    ...
    # svm 0.72 0.84 0.64
    svm =sklearn.svm.SVC(C=2, kernel='poly', degree=10, gamma=20, decision_function_shape='ovr')      #acc=0.9534
